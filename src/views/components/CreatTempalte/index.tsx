  ...
  return (
    <div className="template-con">
      ...
      <div className="template-form">
        <div className="template-form-title">Define Template</div>
        <div className="template-form-input-item">
          <div>Template name<span className="require">*</span><span className="input-des">Only alphanumeric characters allowed. No spaces.</span></div>
        ...
        {classfications.map((item: any, index: number) => <div key={index} className="template-form-class-item">
        ...
        <div className="date-check"><Checkbox value={isExpirable} onChange={(e) => setIsExpirable(e.target.checked)}><span className="check-des">Mandatory claim expiration date (Optional)</span></Checkbox></div>
